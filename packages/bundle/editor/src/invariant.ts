/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-editor-app`.
 * @module @deepseek-ai/dsh-editor-app/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-editor-app'

/** Cordis companion plugin name. */
export const name = 'editor-bundle-invariant'
